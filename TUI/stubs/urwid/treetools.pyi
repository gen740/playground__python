...
from urwid.wimp import SelectableIcon as SelectableIcon
...
class TreeNode:
    def __init__(self, value, parent: Any | None = ..., key: Any | None = ..., depth: Any | None = ...) -> None: ...
...
class TreeListBox(urwid.ListBox):
    ...
    def collapse_focus_parent(self, size) -> None: ...
    def move_focus_to_parent(self, size) -> None: ...
    def focus_home(self, size) -> None: ...
    def focus_end(self, size) -> None: ...
