...
def quad_vec(f, a, b, epsabs=..., epsrel=..., norm=..., cache_size=..., limit=..., workers=..., points=..., quadrature=..., full_output=...): # -> tuple[float | complex | Unknown | None, Unknown, _Bunch] | tuple[float | complex | Unknown | None, Unknown]:
