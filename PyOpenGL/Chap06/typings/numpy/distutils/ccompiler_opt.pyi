...
class _Feature:
    ...
    def feature_names(self, names=..., force_flags=...):
        """
    ...
    @_Cache.me
    def feature_test(self, name, force_flags=...):
        """
    ...
    @_Cache.me
    def feature_is_supported(self, name, force_flags=...):
        """
...
class CCompilerOpt(_Config, _Distutils, _Cache, _CCompiler, _Feature, _Parse):
    ...
    def try_dispatch(self, sources, src_dir=..., **kwargs):
        """
