...
def group_columns(A, order=...): # -> NDArray:
...
def approx_derivative(fun, x0, method=..., rel_step=..., abs_step=..., f0=..., bounds=..., sparsity=..., as_linear_operator=..., args=..., kwargs=...): # -> LinearOperator | csr_matrix:
