...
class BSpline:
    ...
    **Implementation details**
    ...
    @classmethod
    def construct_fast(cls, t, c, k, extrapolate=..., axis=...): # -> Any:
    ...
    @property
    def tck(self): # -> tuple[ndarray | Unknown, ndarray | Unknown, int]:
        """Equivalent to ``(self.t, self.c, self.k)`` (read-only).
        """
        ...
    
    @classmethod
    def basis_element(cls, t, extrapolate=...): # -> Any:
...
def make_interp_spline(x, y, k=..., t=..., bc_type=..., axis=..., check_finite=...): # -> Any:
...
def make_lsq_spline(x, y, t, k=..., w=..., axis=..., check_finite=...): # -> Any:
