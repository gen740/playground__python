...
def prepare_input(x, y, axis, dydx=...): # -> tuple[Unknown, Unknown, ndarray, Unknown, ndarray | Unknown]:
...
def pchip_interpolate(xi, yi, x, der=..., axis=...): # -> ndarray[Any, Unknown] | Any | list[Unknown | Any]:
    """
