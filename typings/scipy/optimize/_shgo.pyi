...
class SHGO:
    ...
    def simplex_minimizers(self): # -> ndarray:
        """
    ...
    def minimize(self, x_min, ind=...): # -> OptimizeResult:
        """
    ...
    def sampling_custom(self, n, dim): # -> ndarray:
        """
    ...
    def sorted_samples(self): # -> tuple[ndarray, Any | Unknown]:
