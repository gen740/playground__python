...
def estimate_fun_jac(fun, x, y, p, f0=...): # -> tuple[ndarray, ndarray | None]:
...
def estimate_bc_jac(bc, ya, yb, p, bc0=...): # -> tuple[Unknown, Unknown, Unknown | None]:
...
def compute_jac_indices(n, m, k): # -> tuple[ndarray, ndarray]:
...
def stacked_matmul(a, b): # -> ndarray | Any:
...
def modify_mesh(x, insert_1, insert_2): # -> ndarray:
...
def wrap_functions(fun, bc, fun_jac, bc_jac, k, a, S, D, dtype): # -> tuple[(x: Unknown, y: Unknown, p: Unknown) -> (ndarray | Unknown), (ya: Unknown, yb: Unknown, _: Unknown) -> ndarray | (x: Unknown, y: Unknown, p: Unknown) -> ndarray, (x: Unknown, y: Unknown, p: Unknown) -> tuple[ndarray | Unknown, ndarray] | Unbound, (ya: Unknown, yb: Unknown, _: Unknown) -> tuple[ndarray, ndarray, None] | (ya: Unknown, yb: Unknown, p: Unknown) -> tuple[ndarray, ndarray, ndarray] | Unbound]:
