...
from numpy import _ModeKind, _OrderACF, _OrderKACF, _PartitionKind, _SortKind, _SortSide, bool_, generic, intp, ndarray
from numpy.typing import ArrayLike, DTypeLike, _ArrayLikeBool_co, _ArrayLikeInt_co, _NumberLike_co, _Shape, _ShapeLike
...
_ScalarGeneric = ...
_Number = ...
def take(a: ArrayLike, indices: _ArrayLikeInt_co, axis: Optional[int] = ..., out: Optional[ndarray] = ..., mode: _ModeKind = ...) -> Any:
    ...

def reshape(a: ArrayLike, newshape: _ShapeLike, order: _OrderACF = ...) -> ndarray:
    ...

def choose(a: _ArrayLikeInt_co, choices: ArrayLike, out: Optional[ndarray] = ..., mode: _ModeKind = ...) -> Any:
    ...

def repeat(a: ArrayLike, repeats: _ArrayLikeInt_co, axis: Optional[int] = ...) -> ndarray:
    ...

def put(a: ndarray, ind: _ArrayLikeInt_co, v: ArrayLike, mode: _ModeKind = ...) -> None:
    ...
...
def partition(a: ArrayLike, kth: _ArrayLikeInt_co, axis: Optional[int] = ..., kind: _PartitionKind = ..., order: Union[None, str, Sequence[str]] = ...) -> ndarray:
    ...

def argpartition(a: ArrayLike, kth: _ArrayLikeInt_co, axis: Optional[int] = ..., kind: _PartitionKind = ..., order: Union[None, str, Sequence[str]] = ...) -> Any:
    ...
...
@overload
def searchsorted(a: ArrayLike, v: _Scalar, side: _SortSide = ..., sorter: Optional[_ArrayLikeInt_co] = ...) -> intp:
    ...

@overload
def searchsorted(a: ArrayLike, v: ArrayLike, side: _SortSide = ..., sorter: Optional[_ArrayLikeInt_co] = ...) -> ndarray:
    ...
...
def sum(a: ArrayLike, axis: _ShapeLike = ..., dtype: DTypeLike = ..., out: Optional[ndarray] = ..., keepdims: bool = ..., initial: _NumberLike_co = ..., where: _ArrayLikeBool_co = ...) -> Any:
    ...
...
def amax(a: ArrayLike, axis: Optional[_ShapeLike] = ..., out: Optional[ndarray] = ..., keepdims: bool = ..., initial: _NumberLike_co = ..., where: _ArrayLikeBool_co = ...) -> Any:
    ...

def amin(a: ArrayLike, axis: Optional[_ShapeLike] = ..., out: Optional[ndarray] = ..., keepdims: bool = ..., initial: _NumberLike_co = ..., where: _ArrayLikeBool_co = ...) -> Any:
    ...

def prod(a: ArrayLike, axis: Optional[_ShapeLike] = ..., dtype: DTypeLike = ..., out: Optional[ndarray] = ..., keepdims: bool = ..., initial: _NumberLike_co = ..., where: _ArrayLikeBool_co = ...) -> Any:
    ...
