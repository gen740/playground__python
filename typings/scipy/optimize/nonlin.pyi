...
_doc_parts = ...
def nonlin_solve(F, x0, jacobian=..., iter=..., verbose=..., maxiter=..., f_tol=..., f_rtol=..., x_tol=..., x_rtol=..., tol_norm=..., line_search=..., callback=..., full_output=..., raise_exception=...): # -> tuple[Any | Unknown, dict[str, Unknown]] | Any:
    """
...
class LowRankMatrix:
    ...
    def solve(self, v, tol=...): # -> ndarray:
        """Evaluate w = M^-1 v"""
        ...
    
    def rsolve(self, v, tol=...): # -> ndarray:
        """Evaluate w = M^-H v"""
        ...
...
class BroydenFirst(GenericBroyden):
    ...
    def matvec(self, f): # -> ndarray:
        ...
    
    def rsolve(self, f, tol=...):
        ...
    
    def rmatvec(self, f): # -> ndarray:
        ...
