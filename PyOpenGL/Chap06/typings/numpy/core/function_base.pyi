...
from numpy.typing import DTypeLike, _NumberLike, _SupportsArray
...
_ArrayLikeNumber = Union[_NumberLike, Sequence[_NumberLike], ndarray, _SupportsArray, _ArrayLikeNested]
@overload
