...
@docfiller
def spline_filter1d(input, order=..., axis=..., output=..., mode=...): # -> ndarray:
    """
...
def spline_filter(input, order=..., output=..., mode=...): # -> ndarray:
    """
...
@docfiller
def geometric_transform(input, mapping, output_shape=..., output=..., order=..., mode=..., cval=..., prefilter=..., extra_arguments=..., extra_keywords=...): # -> ndarray:
    """
...
@docfiller
def map_coordinates(input, coordinates, output=..., order=..., mode=..., cval=..., prefilter=...): # -> ndarray:
    """
...
@docfiller
def affine_transform(input, matrix, offset=..., output_shape=..., output=..., order=..., mode=..., cval=..., prefilter=...): # -> ndarray:
    """
...
@docfiller
def shift(input, shift, output=..., order=..., mode=..., cval=..., prefilter=...): # -> ndarray:
    """
    Shift an array.
...
@docfiller
def zoom(input, zoom, output=..., order=..., mode=..., cval=..., prefilter=..., *, grid_mode=...): # -> ndarray:
    """
    Zoom an array.
...
@docfiller
def rotate(input, angle, axes=..., reshape=..., output=..., order=..., mode=..., cval=..., prefilter=...): # -> ndarray:
    """
    Rotate an array.
