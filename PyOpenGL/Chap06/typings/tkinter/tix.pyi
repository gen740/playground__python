...
class Tk(tkinter.Tk, tixCommand):
    def __init__(self, screenName: Optional[str] = ..., baseName: Optional[str] = ..., className: str = ...) -> None:
        ...
    


class TixWidget(tkinter.Widget):
    def __init__(self, master: Optional[tkinter.Misc] = ..., widgetName: Optional[str] = ..., static_options: Optional[List[str]] = ..., cnf: Dict[str, Any] = ..., kw: Dict[str, Any] = ...) -> None:
        ...
    ...
    def image_create(self, imgtype: str, cnf: Dict[str, Any] = ..., master: Optional[tkinter.Widget] = ..., **kw: Any) -> None:
        ...
...
class DisplayStyle:
    def __init__(self, itemtype: str, cnf: Dict[str, Any] = ..., *, master: Optional[tkinter.Widget] = ..., **kw: Any) -> None:
        ...
