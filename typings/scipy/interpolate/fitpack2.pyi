...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    @staticmethod
    def validate_input(x, y, w, bbox, k, s, ext, check_finite): # -> tuple[ndarray, ndarray, Unknown | ndarray, ndarray, int]:
        ...
    ...
    def __call__(self, x, nu=..., ext=...): # -> ndarray | list[Unknown]:
        """
...
class _BivariateSplineBase:
    ...
    def __call__(self, x, y, dx=..., dy=..., grid=...): # -> ndarray:
        """
...
class BivariateSpline(_BivariateSplineBase):
    ...
    bisplev :
        a function to evaluate a bivariate B-spline and its derivatives
    """
    def ev(self, xi, yi, dx=..., dy=...): # -> ndarray:
        """
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    """
    def __call__(self, theta, phi, dtheta=..., dphi=..., grid=...): # -> ndarray:
        """
        Evaluate the spline or its derivatives at given positions.
    ...
    def ev(self, theta, phi, dtheta=..., dphi=...): # -> ndarray:
        """
        Evaluate the spline at points
