...
def cophenet(Z, Y=...): # -> ndarray | tuple[Any, ndarray]:
    """
...
def from_mlab_linkage(Z): # -> ndarray:
    """
...
def fcluster(Z, t, criterion=..., depth=..., R=..., monocrit=...): # -> ndarray:
    """
...
def fclusterdata(X, t, criterion=..., metric=..., depth=..., method=..., R=...): # -> ndarray:
    """
...
def dendrogram(Z, p=..., truncate_mode=..., color_threshold=..., get_leaves=..., orientation=..., labels=..., count_sort=..., distance_sort=..., show_leaf_counts=..., no_plot=..., no_labels=..., leaf_font_size=..., leaf_rotation=..., leaf_label_func=..., show_contracted=..., link_color_func=..., ax=..., above_threshold_color=...): # -> dict[str, Unknown]:
    """
...
def leaders(Z, T): # -> tuple[ndarray, ndarray]:
    """
