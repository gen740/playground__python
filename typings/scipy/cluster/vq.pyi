...
def vq(obs, code_book, check_finite=...): # -> tuple[Unknown, Unknown]:
    """
...
def py_vq(obs, code_book, check_finite=...): # -> tuple[Unknown, Unknown]:
...
py_vq2 = ...
def kmeans(obs, k_or_guess, iter=..., thresh=..., check_finite=..., *, seed=...): # -> tuple[ndarray | Any, float] | tuple[Unbound | ndarray | Any, float]:
    """
...
_valid_init_meth = ...
_valid_miss_meth = ...
def kmeans2(data, k, iter=..., thresh=..., minit=..., missing=..., check_finite=..., *, seed=...): # -> tuple[ndarray | Unknown, Unbound | Unknown]:
    """
