...
def expm_frechet(A, E, method=..., compute_expm=..., check_finite=...): # -> tuple[Unknown | Any, Unknown | Any] | Any:
    """
...
def expm_frechet_block_enlarge(A, E): # -> tuple[Any | Unknown, Any | Unknown]:
    """
