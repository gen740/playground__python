...
from numpy.typing import ArrayLike, DTypeLike, NBitBase, NDArray, _128Bit, _16Bit, _256Bit, _32Bit, _64Bit, _80Bit, _8Bit, _96Bit, _ArrayLikeBool_co, _ArrayLikeComplex_co, _ArrayLikeDT64_co, _ArrayLikeFloat_co, _ArrayLikeInt_co, _ArrayLikeNumber_co, _ArrayLikeObject_co, _ArrayLikeTD64_co, _ArrayLikeUInt_co, _BoolCodes, _BoolLike_co, _ByteCodes, _BytesCodes, _CDoubleCodes, _CLongDoubleCodes, _CSingleCodes, _CharLike_co, _Complex128Codes, _Complex64Codes, _ComplexLike_co, _DT64Codes, _DoubleCodes, _Float16Codes, _Float32Codes, _Float64Codes, _FloatLike_co, _GUFunc_Nin2_Nout1, _HalfCodes, _Int16Codes, _Int32Codes, _Int64Codes, _Int8Codes, _IntCCodes, _IntCodes, _IntLike_co, _IntPCodes, _LongDoubleCodes, _LongLongCodes, _NBitByte, _NBitDouble, _NBitHalf, _NBitInt, _NBitIntC, _NBitIntP, _NBitLongDouble, _NBitLongLong, _NBitShort, _NBitSingle, _NestedSequence, _NumberLike_co, _ObjectCodes, _RecursiveSequence, _ScalarLike_co, _Shape, _ShapeLike, _ShortCodes, _SingleCodes, _StrCodes, _SupportsArray, _SupportsDType, _TD64Codes, _TD64Like_co, _UByteCodes, _UFunc_Nin1_Nout1, _UFunc_Nin1_Nout2, _UFunc_Nin2_Nout1, _UFunc_Nin2_Nout2, _UInt16Codes, _UInt32Codes, _UInt64Codes, _UInt8Codes, _UIntCCodes, _UIntCodes, _UIntPCodes, _ULongLongCodes, _UShortCodes, _VoidCodes, _VoidDTypeLike
...
from numpy.typing._extended_precision import complex160 as complex160, complex192 as complex192, complex256 as complex256, complex512 as complex512, float128 as float128, float256 as float256, float80 as float80, float96 as float96, int128 as int128, int256 as int256, uint128 as uint128, uint256 as uint256
from typing import Any, ByteString, Callable, Container, Dict, Final, Generic, IO, Iterable, List, Literal as L, Mapping, NoReturn, Optional, Protocol, Sequence, Sized, SupportsComplex, SupportsFloat, SupportsIndex, SupportsInt, Text, Tuple, Type, TypeVar, Union, overload
from numpy import char as char, ctypeslib as ctypeslib, fft as fft, lib as lib, linalg as linalg, ma as ma, matrixlib as matrixlib, polynomial as polynomial, random as random, rec as rec, testing as testing, version as version
...
from numpy.lib.npyio import fromregex as fromregex, genfromtxt as genfromtxt, load as load, loads as loads, loadtxt as loadtxt, packbits as packbits, recfromcsv as recfromcsv, recfromtxt as recfromtxt, save as save, savetxt as savetxt, savez as savez, savez_compressed as savez_compressed, unpackbits as unpackbits
...
class dtype(Generic[_DTypeScalar_co]):
    ...
    @property
    def fields(self) -> Optional[Mapping[str, Union[Tuple[dtype[Any], int], Tuple[dtype[Any], int, Any]]]]:
        ...
...
class flatiter(Generic[_NdArraySubClass]):
    ...
    @overload
    def __getitem__(self: flatiter[ndarray[Any, dtype[_ScalarType]]], key: Union[int, integer]) -> _ScalarType:
        ...
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    @overload
    def item(self: ndarray[Any, dtype[_SupportsItem[_T]]], *args: SupportsIndex) -> _T:
        ...
    
    @overload
    def item(self: ndarray[Any, dtype[_SupportsItem[_T]]], __args: Tuple[SupportsIndex, ...]) -> _T:
        ...
    ...
    def argpartition(self, kth: _ArrayLikeInt_co, axis: Optional[SupportsIndex] = ..., kind: _PartitionKind = ..., order: Union[None, str, Sequence[str]] = ...) -> ndarray[Any, dtype[intp]]:
        ...
    ...
    @overload
    def searchsorted(self, v: ArrayLike, side: _SortSide = ..., sorter: Optional[_ArrayLikeInt_co] = ...) -> ndarray[Any, dtype[intp]]:
        ...
    ...
    @overload
    def take(self: ndarray[Any, dtype[_ScalarType]], indices: _IntLike_co, axis: Optional[SupportsIndex] = ..., out: None = ..., mode: _ModeKind = ...) -> _ScalarType:
        ...
    ...
    def __int__(self: ndarray[Any, dtype[SupportsInt]]) -> int:
        ...
    
    def __float__(self: ndarray[Any, dtype[SupportsFloat]]) -> float:
        ...
    
    def __complex__(self: ndarray[Any, dtype[SupportsComplex]]) -> complex:
        ...
    
    def __index__(self: ndarray[Any, dtype[SupportsIndex]]) -> int:
        ...
    ...
    @overload
    def __lt__(self: NDArray[Union[number[Any], datetime64, timedelta64, bool_]], other: _RecursiveSequence) -> NDArray[bool_]:
        ...
    ...
    @overload
    def __le__(self: NDArray[Union[number[Any], datetime64, timedelta64, bool_]], other: _RecursiveSequence) -> NDArray[bool_]:
        ...
    ...
    @overload
    def __gt__(self: NDArray[Union[number[Any], datetime64, timedelta64, bool_]], other: _RecursiveSequence) -> NDArray[bool_]:
        ...
    ...
    @overload
    def __ge__(self: NDArray[Union[number[Any], datetime64, timedelta64, bool_]], other: _RecursiveSequence) -> NDArray[bool_]:
        ...
    ...
    @overload
    def __mod__(self: NDArray[Union[bool_, integer[Any], floating[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rmod__(self: NDArray[Union[bool_, integer[Any], floating[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __divmod__(self: NDArray[Union[bool_, integer[Any], floating[Any], timedelta64]], other: _RecursiveSequence) -> _2Tuple[Any]:
        ...
    ...
    @overload
    def __rdivmod__(self: NDArray[Union[bool_, integer[Any], floating[Any], timedelta64]], other: _RecursiveSequence) -> _2Tuple[Any]:
        ...
    ...
    @overload
    def __add__(self: NDArray[Union[bool_, number[Any], timedelta64, datetime64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __radd__(self: NDArray[Union[bool_, number[Any], timedelta64, datetime64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __sub__(self: NDArray[Union[bool_, number[Any], timedelta64, datetime64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rsub__(self: NDArray[Union[bool_, number[Any], timedelta64, datetime64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __mul__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rmul__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __floordiv__(self: _ArrayComplex_co, other: _ArrayLikeComplex_co) -> NDArray[complexfloating[Any, Any]]:
        ...
    ...
    @overload
    def __floordiv__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rfloordiv__(self: _ArrayComplex_co, other: _ArrayLikeComplex_co) -> NDArray[complexfloating[Any, Any]]:
        ...
    ...
    @overload
    def __rfloordiv__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __pow__(self: NDArray[Union[bool_, number[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rpow__(self: NDArray[Union[bool_, number[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __truediv__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rtruediv__(self: NDArray[Union[bool_, number[Any], timedelta64]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __lshift__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rlshift__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rshift__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rrshift__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __and__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rand__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __xor__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __rxor__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __or__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
    ...
    @overload
    def __ror__(self: NDArray[Union[bool_, integer[Any]]], other: _RecursiveSequence) -> Any:
        ...
...
class generic(_ArrayOrScalarCommon):
    ...
    @overload
    def take(self: _ScalarType, indices: _IntLike_co, axis: Optional[SupportsIndex] = ..., out: None = ..., mode: _ModeKind = ...) -> _ScalarType:
        ...
    
    @overload
    def take(self: _ScalarType, indices: _ArrayLikeInt_co, axis: Optional[SupportsIndex] = ..., out: None = ..., mode: _ModeKind = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
    ...
    def repeat(self: _ScalarType, repeats: _ArrayLikeInt_co, axis: Optional[SupportsIndex] = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
    
    def flatten(self: _ScalarType, order: _OrderKACF = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
    
    def ravel(self: _ScalarType, order: _OrderKACF = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
    
    @overload
    def reshape(self: _ScalarType, __shape: _ShapeLike, *, order: _OrderACF = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
    
    @overload
    def reshape(self: _ScalarType, *shape: SupportsIndex, order: _OrderACF = ...) -> ndarray[Any, dtype[_ScalarType]]:
        ...
