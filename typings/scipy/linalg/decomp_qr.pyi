...
def qr(a, overwrite_a=..., lwork=..., mode=..., pivoting=..., check_finite=...): # -> tuple[Unknown, Unknown | Unbound] | tuple[Unknown] | Tuple[tuple[Unknown, Unknown], ...] | Tuple[Unknown, ...]:
    """
...
def qr_multiply(a, c, mode=..., pivoting=..., conjugate=..., overwrite_a=..., overwrite_c=...): # -> Tuple[Unknown, ...]:
    """
