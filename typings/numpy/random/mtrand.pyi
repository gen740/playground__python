...
from numpy import bool_, dtype, float64, int16, int32, int64, int8, int_, ndarray, uint, uint16, uint32, uint64, uint8
from numpy.random.bit_generator import BitGenerator
from numpy.typing import ArrayLike, _ArrayLikeFloat_co, _ArrayLikeInt_co, _DTypeLikeBool, _DTypeLikeInt, _DTypeLikeUInt, _Int16Codes, _Int32Codes, _Int64Codes, _Int8Codes, _IntCodes, _ShapeLike, _SupportsDType, _UInt16Codes, _UInt32Codes, _UInt64Codes, _UInt8Codes, _UIntCodes
...
class RandomState:
    ...
    @overload
    def get_state(self, legacy: Literal[True] = ...) -> Union[Dict[str, Any], Tuple[str, ndarray[Any, dtype[uint32]], int, int, float]]:
        ...
    
    def set_state(self, state: Union[Dict[str, Any], Tuple[str, ndarray[Any, dtype[uint32]], int, int, float]]) -> None:
        ...
    ...
    @overload
    def randint(self, low: int, high: Optional[int] = ..., size: None = ..., dtype: _DTypeLikeBool = ...) -> bool:
        ...
    
    @overload
    def randint(self, low: int, high: Optional[int] = ..., size: None = ..., dtype: Union[_DTypeLikeInt, _DTypeLikeUInt] = ...) -> int:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: _DTypeLikeBool = ...) -> ndarray[Any, dtype[bool_]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[int8], Type[int8], _Int8Codes, _SupportsDType[dtype[int8]]] = ...) -> ndarray[Any, dtype[int8]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[int16], Type[int16], _Int16Codes, _SupportsDType[dtype[int16]]] = ...) -> ndarray[Any, dtype[int16]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[int32], Type[int32], _Int32Codes, _SupportsDType[dtype[int32]]] = ...) -> ndarray[Any, dtype[Union[int32]]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Optional[Union[dtype[int64], Type[int64], _Int64Codes, _SupportsDType[dtype[int64]]]] = ...) -> ndarray[Any, dtype[int64]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[uint8], Type[uint8], _UInt8Codes, _SupportsDType[dtype[uint8]]] = ...) -> ndarray[Any, dtype[uint8]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[uint16], Type[uint16], _UInt16Codes, _SupportsDType[dtype[uint16]]] = ...) -> ndarray[Any, dtype[Union[uint16]]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[uint32], Type[uint32], _UInt32Codes, _SupportsDType[dtype[uint32]]] = ...) -> ndarray[Any, dtype[uint32]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[uint64], Type[uint64], _UInt64Codes, _SupportsDType[dtype[uint64]]] = ...) -> ndarray[Any, dtype[uint64]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[int_], Type[int], Type[int_], _IntCodes, _SupportsDType[dtype[int_]]] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    
    @overload
    def randint(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ..., dtype: Union[dtype[uint], Type[uint], _UIntCodes, _SupportsDType[dtype[uint]]] = ...) -> ndarray[Any, dtype[uint]]:
        ...
    ...
    @overload
    def choice(self, a: int, size: None = ..., replace: bool = ..., p: Optional[_ArrayLikeFloat_co] = ...) -> int:
        ...
    
    @overload
    def choice(self, a: int, size: _ShapeLike = ..., replace: bool = ..., p: Optional[_ArrayLikeFloat_co] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    
    @overload
    def choice(self, a: ArrayLike, size: None = ..., replace: bool = ..., p: Optional[_ArrayLikeFloat_co] = ...) -> Any:
        ...
    
    @overload
    def choice(self, a: ArrayLike, size: _ShapeLike = ..., replace: bool = ..., p: Optional[_ArrayLikeFloat_co] = ...) -> ndarray[Any, Any]:
        ...
    ...
    @overload
    def random_integers(self, low: int, high: Optional[int] = ..., size: None = ...) -> int:
        ...
    
    @overload
    def random_integers(self, low: _ArrayLikeInt_co, high: Optional[_ArrayLikeInt_co] = ..., size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def binomial(self, n: _ArrayLikeInt_co, p: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def negative_binomial(self, n: _ArrayLikeFloat_co, p: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def poisson(self, lam: _ArrayLikeFloat_co = ..., size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def zipf(self, a: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def geometric(self, p: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def hypergeometric(self, ngood: _ArrayLikeInt_co, nbad: _ArrayLikeInt_co, nsample: _ArrayLikeInt_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    ...
    @overload
    def logseries(self, p: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
    
    def multivariate_normal(self, mean: _ArrayLikeFloat_co, cov: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ..., check_valid: Literal["warn", "raise", "ignore"] = ..., tol: float = ...) -> ndarray[Any, dtype[float64]]:
        ...
    
    def multinomial(self, n: _ArrayLikeInt_co, pvals: _ArrayLikeFloat_co, size: Optional[_ShapeLike] = ...) -> ndarray[Any, dtype[int_]]:
        ...
