...
def solve(a, b, sym_pos=..., lower=..., overwrite_a=..., overwrite_b=..., debug=..., check_finite=..., assume_a=..., transposed=...): # -> ndarray:
    """
...
def solve_toeplitz(c_or_cr, b, check_finite=...):
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> ndarray:
...
def lstsq(a, b, cond=..., overwrite_a=..., overwrite_b=..., check_finite=..., lapack_driver=...): # -> tuple[ndarray, Unknown | ndarray, Literal[0], ndarray] | tuple[Unknown | Unbound, Any | ndarray, Unknown | Unbound, Unknown | Unbound] | tuple[Unknown, ndarray, Unknown, None] | None:
    """
...
def pinv(a, atol=..., rtol=..., return_rank=..., check_finite=..., cond=..., rcond=...): # -> tuple[Unknown, Any]:
    """
