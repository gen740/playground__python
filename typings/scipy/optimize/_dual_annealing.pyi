...
class StrategyChain:
    ...
    def run(self, step, temperature): # -> Literal['Maximum number of function call reached during annealing'] | None:
        ...
...
class LocalSearchWrapper:
    ...
    def local_search(self, x, e): # -> tuple[Unknown, Unknown]:
        ...
    


def dual_annealing(func, bounds, args=..., maxiter=..., local_search_options=..., initial_temp=..., restart_temp_ratio=..., visit=..., accept=..., maxfun=..., seed=..., no_local_search=..., callback=..., x0=...): # -> OptimizeResult:
    """
