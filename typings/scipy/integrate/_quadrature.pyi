...
def vectorize1(func, args=..., vec_func=...): # -> (x: Unknown) -> Unknown | (x: Unknown) -> (Unknown | ndarray):
...
def cumtrapz(y, x=..., dx=..., axis=..., initial=...): # -> ndarray:
...
def cumulative_trapezoid(y, x=..., dx=..., axis=..., initial=...): # -> ndarray:
    """
...
_builtincoeffs = ...
def newton_cotes(rn, equal=...): # -> tuple[Unknown, Unknown]:
    r"""
