...
abs = ...
def findfreqs(num, den, N, kind=...): # -> ndarray:
    """
...
def freqs(b, a, worN=..., plot=...): # -> tuple[ndarray, Unknown]:
    """
...
def freqs_zpk(z, p, k, worN=...): # -> tuple[Unknown, Unknown]:
    """
    Compute frequency response of analog filter.
...
def freqz(b, a=..., worN=..., whole=..., plot=..., fs=..., include_nyquist=...): # -> tuple[Unknown, Unknown | ndarray]:
    """
...
def freqz_zpk(z, p, k, worN=..., whole=..., fs=...): # -> tuple[Unknown, Unknown]:
    r"""
...
def group_delay(system, w=..., whole=..., fs=...): # -> tuple[Unknown, Unknown]:
...
def zpk2tf(z, p, k): # -> tuple[Unknown | ndarray, Unknown | ndarray]:
    """
...
def tf2sos(b, a, pairing=...): # -> ndarray:
    """
...
def sos2tf(sos): # -> tuple[ndarray | Unknown, ndarray | Unknown]:
    """
...
def sos2zpk(sos): # -> tuple[ndarray, ndarray, float | Unknown]:
    """
...
def zpk2sos(z, p, k, pairing=...): # -> ndarray:
    """
...
def iirdesign(wp, ws, gpass, gstop, analog=..., ftype=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
...
def iirfilter(N, Wn, rp=..., rs=..., btype=..., analog=..., ftype=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def lp2lp_zpk(z, p, k, wo=...): # -> tuple[NoReturn, NoReturn, Unknown]:
    r"""
    Transform a lowpass filter prototype to a different frequency.
...
def lp2hp_zpk(z, p, k, wo=...): # -> tuple[Unknown, NoReturn, Unknown]:
    r"""
    Transform a lowpass filter prototype to a highpass filter.
...
def butter(N, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def cheby1(N, rp, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def cheby2(N, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def ellip(N, rp, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def bessel(N, Wn, btype=..., analog=..., output=..., norm=..., fs=...): # -> tuple[Unknown | NoReturn, Unknown | NoReturn, Unknown] | tuple[Unknown | ndarray, Unknown | ndarray] | ndarray | None:
    """
...
def buttord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | ndarray]:
...
def cheb1ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NoReturn]:
...
def cheb2ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | ndarray]:
...
_POW10_LOG10 = ...
def ellipord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NoReturn]:
...
def buttap(N): # -> tuple[ndarray, Any, Literal[1]]:
...
def cheb1ap(N, rp): # -> tuple[ndarray, ndarray, Unknown] | tuple[ndarray, Any, Any]:
    """
...
def cheb2ap(N, rs): # -> tuple[ndarray, ndarray, Literal[1]] | tuple[Any, Any, Any]:
    """
    Return (z,p,k) for Nth-order Chebyshev type I analog lowpass filter.
...
_ELLIPDEG_MMAX = ...
_ARC_JAC_SN_MAXITER = ...
def ellipap(N, rp, rs): # -> tuple[ndarray, ndarray, Unknown] | tuple[ndarray, ndarray, Any] | tuple[Unknown, Unknown, Any]:
...
def besselap(N, norm=...): # -> tuple[ndarray, ndarray, float]:
    """
...
def iirnotch(w0, Q, fs=...): # -> tuple[Unknown, ndarray]:
    """
...
def iirpeak(w0, Q, fs=...): # -> tuple[Unknown, ndarray]:
    """
...
def iircomb(w0, Q, ftype=..., fs=...): # -> tuple[ndarray, ndarray]:
    """
...
def gammatone(freq, ftype, order=..., numtaps=..., fs=...): # -> tuple[Unknown | ndarray | Unbound, list[float] | ndarray | Unbound]:
    """
