...
_modedict = ...
_boundarydict = ...
def correlate(in1, in2, mode=..., method=...): # -> Any | ndarray:
    r"""
...
def fftconvolve(in1, in2, mode=..., axes=...): # -> ndarray:
...
def oaconvolve(in1, in2, mode=..., axes=...): # -> ndarray:
...
def convolve(in1, in2, mode=..., method=...): # -> Any | ndarray:
    """
...
def lfilter(b, a, x, axis=..., zi=...): # -> tuple[Unknown, Unknown]:
    """
...
def deconvolve(signal, divisor): # -> tuple[Unknown | tuple[Unknown, Unknown] | list[Unknown], ndarray | Any | Unknown | NoReturn]:
...
def cmplx_sort(p): # -> tuple[Any, ndarray]:
...
def unique_roots(p, tol=..., rtype=...): # -> tuple[ndarray, ndarray]:
...
def invres(r, p, k, tol=..., rtype=...): # -> tuple[Unknown | Literal[0], ndarray | Unknown]:
...
def residue(b, a, tol=..., rtype=...): # -> tuple[ndarray, Any, ndarray] | tuple[Unknown, Unknown, ndarray | Unknown]:
...
def residuez(b, a, tol=..., rtype=...): # -> tuple[ndarray, Any, ndarray] | tuple[Unknown, Unknown, Any | Unknown]:
...
def invresz(r, p, k, tol=..., rtype=...): # -> tuple[Unknown, ndarray | Unknown]:
...
def detrend(data, axis=..., type=..., bp=..., overwrite_data=...): # -> Any | ndarray:
    """
...
def filtfilt(b, a, x, axis=..., padtype=..., padlen=..., method=..., irlen=...): # -> Any | ndarray:
    """
...
def sosfilt(sos, x, axis=..., zi=...): # -> tuple[ndarray, ndarray] | ndarray:
    """
...
def decimate(x, q, n=..., ftype=..., axis=..., zero_phase=...): # -> Any:
    """
