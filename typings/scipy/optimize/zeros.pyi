...
def newton(func, x0, fprime=..., args=..., tol=..., maxiter=..., fprime2=..., x1=..., rtol=..., full_output=..., disp=...): # -> result | ndarray | tuple[Unknown, RootResults]:
    """
...
class TOMS748Solver:
    ...
    def get_result(self, x, flag=...): # -> tuple[Unknown, int, int, Unknown]:
